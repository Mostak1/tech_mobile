        ...
        <tbody>
            ...
            <tr style="border-bottom: 1px solid #e5e7eb; background: {{$rowIndex % 2 == 0 ? '#ffffff' : '#f9fafb'}};">
                <td style="padding: 5px; vertical-align: top;">
                    ...
                    @endif
                    @if(!empty($detail['enable_serial_tracking']) && !empty($detail['serial_numbers']))
                        <div style="font-size: 7pt; color: #10b981; margin-top: 1px;">{{ __('pdf.sn') }} {{ implode(', ', $detail['serial_numbers']) }}</div>
                    @endif
                </td>
