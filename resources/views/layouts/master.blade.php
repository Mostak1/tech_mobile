...
<html lang="en">
  <head>
    ...
    <meta name="apple-mobile-web-app-title" content="{{ $app_settings->app_name ?? 'TechSeba' }}">
    <link rel="apple-touch-icon" href="{{ asset('pwa_images/pwa-icon-192.png') }}">

    <title>{{ $app_settings->app_name ?? 'TechSeba' }}</title>
  ...
  <body class="text-left">
    <noscript>
      <strong>
        We're sorry but TechSeba doesn't work properly without JavaScript
    ...
    <script src="{{ asset('js/main.min.js') }}?v=5.6&v={{ time() }}"></script>
