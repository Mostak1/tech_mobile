              ...
              <template v-for="(detail, index) in details">
                <tr :key="'d-' + index" :class="{'invoice-products-row-even': index % 2 === 1}">
                  <td class="invoice-product-name-cell">
                    ...
                    <div v-if="detail.enable_serial_tracking && detail.serial_numbers && detail.serial_numbers.length" class="invoice-product-imei">
                      SN: {{ detail.serial_numbers.join(', ') }}
                    </div>
                  </td>
          ...
          <div class="invoice-products-mobile">
            ...
            >
              ...
              <div class="invoice-product-card-body">
                ...
                <div v-if="detail.enable_serial_tracking && detail.serial_numbers && detail.serial_numbers.length" class="invoice-product-card-row">
                  <span class="invoice-product-card-label">SN:</span>
                  <span class="invoice-product-card-value">{{ detail.serial_numbers.join(', ') }}</span>
                </div>
